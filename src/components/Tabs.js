...
import {PHOTOGRAPHY, WEB_DEVELOPMENT, DATA_SCIENCE, AWS, DESIGN, MARKETING} from "../utils/constants";
      ...
      <div className='tabs'>
        <ul className='flex flex-wrap'>
          <li className='tabs-head-item'>
            <button type = "button" className={`tab-btn ${activeTab === PHOTOGRAPHY}`} onClick = {() => tabHandler(PHOTOGRAPHY)}>Photography</button>
          </li>
          <li className='tabs-head-item'>
