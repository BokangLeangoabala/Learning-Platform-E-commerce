...
const courses = [
    {
        ...
        course_name: "Learn Photography from stratch with this beginner friendly course",
        description: "Learn A-Z everything about Photography, from the basics, to advanced topics and more!",
        rating_count: 3059,
        rating_star: 4.6,
        students: 18430,
        creator: "Albert Maddison",
        updated_date: "9/2015",
        lang: "english",
        actual_price: 94.99,
        discounted_price: 19.99,
        what_you_will_learn: [
            "Create their own Photography albums",
            "Become an experienced Photographer",
            "Become experinced and capture increadible photos"
        ],
        content: [
            "Up and Running With Photography",
            "The Basics(Lighting)",
            "Posing",
            "Lenses",
            "Classes! (Potrait and still photography)",
            "File Input/Output",
            "Using Photography Modules"
        ]
    },
    {
        id: "dtfo9e",
        ...
        course_name: "Learning Photography for Editing and Lighting",
        description: "Learn photography and how to use it to take breath taking memories. Includes tons of sample pictures and hours of video!",
        rating_count: 3059,
        rating_star: 4.3,
        students: 184053,
        creator: "Joseph Presilla",
        updated_date: "9/2020",
        lang: "english",
        actual_price: 64.99,
        discounted_price: 9.99,
        what_you_will_learn: [
            "Have an intermediate skill level of Photography.",
            "Use the editing studio to create and manipulate pictures.",
            "Learn how to work with various forms of picture editors",
            "Have a portfolio of various pictures"
        ],
        content: [
            "Intro to Editing and Kighting",
            "Learn to edit your photos",
            "Picture Visualization",
            "Example Photos",
            "Lighting fundamentals",
            "Editing with adobe express"
        ]
    },
    {
        id: "fLroW6",
        ...
        course_name: "Beginner to mastery - Photography course",
        description: "Photography For Beginners : This course is meant for absolute beginners in photography!",
        rating_count: 1844,
        rating_star: 4.4,
        students: 7330,
        creator: "Jacob Mizzler",
        updated_date: "5/2022",
        lang: "english",
        actual_price: 120.99,
        ...
        what_you_will_learn: [
            ...
            "To learn the CORE skills to understand how to take pictures",
        ],
        content: [
    ...
    },
    {
        ...
        course_name: "Become a professional photographer.",
        ...
        what_you_will_learn: [
            ...
            "Acquire new photography skills and well kept secrets"
        ],
        content: [
            "Getting Started",
            "The Basics",
            "Intermidiate Photography",
            "Editing",
            "Mastery",
            "Posing and Ligting",
        ]
    },
    {
        ...
        course_name: "Photography Beyond the Basics - Frame rate photography",
        description: "From frame rates to lighting and editing we have all you need.",
        rating_count: 2941,
        rating_star: 4.3,
        students: 10450,
        ...
        what_you_will_learn: [
            "Design Reusable Photos",
            "How to handle misphotos",
            "Work with Photography file handling",
            "Apply OOP Concepts to handle lighting"
        ],
        content: [
            ...
            "Using adobe editor",
            "Advanced Features",
            "Combine all aspects and make a masterpiece"
        ]
    },
    {
        id: "qjdYG4",
